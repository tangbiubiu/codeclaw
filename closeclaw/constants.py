...
SHELL_SYSTEM_DIRECTORIES = frozenset(["bin", "boot", "dev", "etc", "lib", "lib64", "proc", "root", "sbin", "sys", "usr", "var"])
SHELL_READ_ONLY_COMMANDS = frozenset(["ls", "cat", "echo", "pwd", "head", "tail", "wc", "sort", "uniq", "cut", "tr", "find", "rg", "grep"])
SHELL_SAFE_GIT_SUBCOMMANDS = frozenset(["status", "log", "diff", "show", "branch", "remote", "config", "ls-files"])
